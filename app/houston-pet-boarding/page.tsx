      ...
      <section style={{ backgroundColor: "#F8F8F8", padding: "80px 20px" }}>
        <div style={{ maxWidth: "1520px", margin: "0 auto" }}>
          ...
          <div className="amenities-grid">
            {[
              { icon: <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="18" width="32" height="4" rx="2" fill="#965B83"/><rect x="6" y="14" width="28" height="6" rx="3" fill="#965B83" opacity=".5"/><rect x="4" y="22" width="4" height="8" rx="1" fill="#965B83" opacity=".7"/><rect x="32" y="22" width="4" height="8" rx="1" fill="#965B83" opacity=".7"/><path d="M10 14c0-3 2-6 5-6h10c3 0 5 3 5 6" stroke="#965B83" strokeWidth="2" fill="none"/></svg>, title: "Elevated Padded Beds", desc: "Each pet sleeps on a raised, padded bed — no cold concrete floors." },
              { icon: <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="16" y="4" width="8" height="24" rx="4" stroke="#965B83" strokeWidth="2.5"/><rect x="18" y="6" width="4" height="10" rx="2" fill="#965B83" opacity=".4"/><path d="M12 22a8 8 0 0016 0" stroke="#965B83" strokeWidth="2.5" fill="none"/><circle cx="20" cy="34" r="2.5" fill="#965B83"/><line x1="20" y1="31" x2="20" y2="28" stroke="#965B83" strokeWidth="2"/></svg>, title: "Climate-Controlled Suites", desc: "Private suites maintain comfortable temperatures year-round for your pet's comfort." },
              { icon: <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="14" cy="14" r="5" stroke="#965B83" strokeWidth="2.5"/><circle cx="14" cy="12" r="1.5" fill="#965B83"/><path d="M10 20c-3 2-5 5-5 9h18c0-4-2-7-5-9" stroke="#965B83" strokeWidth="2" fill="#965B83" opacity=".3"/><path d="M26 10l4-3m0 0l4 2m-4-2v5" stroke="#965B83" strokeWidth="2" strokeLinecap="round"/><circle cx="26" cy="14" r="3" stroke="#965B83" strokeWidth="2"/></svg>, title: "Daily Playgroups", desc: "Minimum 4 play periods per day with 30+ minutes outside in the dog park each session." },
              { icon: <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="8" width="32" height="22" rx="3" stroke="#965B83" strokeWidth="2.5"/><circle cx="20" cy="19" r="5" stroke="#965B83" strokeWidth="2"/><circle cx="20" cy="19" r="2" fill="#965B83"/><rect x="14" y="30" width="12" height="2" rx="1" fill="#965B83"/><circle cx="30" cy="12" r="2" fill="#965B83" opacity=".5"/></svg>, title: "Live Webcam Access", desc: "Watch your pet play and relax in real time via our webcam system — peace of mind guaranteed." },
              { icon: <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16 8l-6 14h6l-2 10 12-16h-7l5-8z" fill="#965B83" opacity=".25" stroke="#965B83" strokeWidth="2" strokeLinejoin="round"/><circle cx="28" cy="10" r="4" stroke="#965B83" strokeWidth="2"/><line x1="24" y1="14" x2="32" y2="6" stroke="#965B83" strokeWidth="2.5" strokeLinecap="round"/></svg>, title: "Optional Grooming", desc: "Combine boarding with a full grooming session so your pet leaves looking their best." },
              { icon: <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="13" cy="16" r="6" stroke="#965B83" strokeWidth="2.5"/><circle cx="27" cy="16" r="6" stroke="#965B83" strokeWidth="2.5"/><circle cx="13" cy="14.5" r="1.5" fill="#965B83"/><circle cx="27" cy="14.5" r="1.5" fill="#965B83"/><path d="M17 22c-1 3-3 6-6 8m12-8c1 3 3 6 6 8" stroke="#965B83" strokeWidth="2" strokeLinecap="round"/><path d="M19 18h2" stroke="#965B83" strokeWidth="2" strokeLinecap="round"/></svg>, title: "Socialization Playgroups", desc: "Pets are matched to appropriate playgroups based on size, temperament, and energy level." },
              { icon: <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20 4l2 6h6l-5 4 2 6-5-4-5 4 2-6-5-4h6z" fill="#965B83" opacity=".3" stroke="#965B83" strokeWidth="1.5"/><rect x="10" y="24" width="20" height="12" rx="3" stroke="#965B83" strokeWidth="2.5"/><line x1="16" y1="28" x2="24" y2="28" stroke="#965B83" strokeWidth="2" strokeLinecap="round"/><line x1="16" y1="32" x2="24" y2="32" stroke="#965B83" strokeWidth="2" strokeLinecap="round"/></svg>, title: "Medication Administration", desc: "Our trained staff can administer medications and follow special dietary requirements." },
              { icon: <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20 6c-1 3-3 5-3 8a3 3 0 006 0c0-3-2-5-3-8z" fill="#965B83" opacity=".4" stroke="#965B83" strokeWidth="2"/><path d="M12 18c-1 2-2 4-2 6a2 2 0 004 0c0-2-1-4-2-6z" fill="#965B83" opacity=".3"/><path d="M28 18c-1 2-2 4-2 6a2 2 0 004 0c0-2-1-4-2-6z" fill="#965B83" opacity=".3"/><path d="M8 30h24c0 0-4-4-12-4s-12 4-12 4z" fill="#965B83" opacity=".2" stroke="#965B83" strokeWidth="2"/><line x1="8" y1="34" x2="32" y2="34" stroke="#965B83" strokeWidth="2.5" strokeLinecap="round"/></svg>, title: "Complimentary Bath", desc: "Select boarding packages include a bath so your pet comes home fresh and clean." },
            ].map((amenity) => (
              <div key={amenity.title} style={{ backgroundColor: "#ffffff", borderRadius: "12px", padding: "30px", boxShadow: "6px 6px 9px rgba(0,0,0,.08)", display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
                <div style={{ marginBottom: "12px" }}>{amenity.icon}</div>
