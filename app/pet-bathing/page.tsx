    ...
    <>
      ...
      <section style={{ backgroundColor: "#965B83", padding: "80px 20px" }}>
        <div style={{ maxWidth: "1520px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "24px" }}>
            {[
              { icon: "🐾", title: "Experienced Bathers", desc: "Our bathers use techniques that make the process calm and enjoyable, even for pets that may be anxious about water or grooming." },
              { icon: "🧴", title: "Premium Products", desc: "We use only top-tier, pet-safe shampoos and conditioners tailored to your dog's specific coat type and skin condition." },
              { icon: "✂️", title: "Breed-Specific Care", desc: "From short-haired breeds to double-coated dogs, we tailor each bath to the specific needs of your pet's breed." },
              { icon: "❤️", title: "Gentle Handling", desc: "Your pet's comfort is our priority. We use calming techniques and patient handling to reduce anxiety throughout the process." },
            ].map((item) => (
      ...
      <section style={{ backgroundColor: "#33373D", padding: "80px 20px" }}>
        <div style={{ maxWidth: "1520px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "60px", alignItems: "center" }}>
          ...
          <div>
            <Image src="https://www.thedoghouseps.com/wp-content/uploads/2025/03/webcam-1.png" alt="Pet webcam at The Dog House" width={600} height={400} style={{ width: "100%", height: "auto", borderRadius: "12px" }} />
          </div>
        </div>
      </section>
