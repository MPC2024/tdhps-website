...
import TermsOfUseHeroText from "@/components/TermsOfUseHeroText";

const HERO_IMAGE_URL = "https://www.thedoghouseps.com/wp-content/uploads/2025/03/image-18.png";
  ...
  return (
    <main style={{ backgroundColor: "#ffffff", minHeight: "60vh" }}>
      ...
      >
        ...
        <Image
          src={HERO_IMAGE_URL}
          alt="Terms of Use - Our policies and conditions"
          fill
          sizes="100vw"
          priority
          quality={85}
      ...
      <section style={{ backgroundColor: "#F8F8F8", padding: "40px 20px 220px" }}>
