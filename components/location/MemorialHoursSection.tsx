...
export default function MemorialHoursSection() {
  const { t } = useLanguage();
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "20px", justifyContent: "center", marginBottom: "24px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            ...
            <span style={{ fontFamily: '"Outfit", sans-serif', fontSize: "14px", color: "#1F2124", fontWeight: 500 }}>Monday-Friday, 7AM - 7PM</span>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            <span style={{ color: "#965B83", fontSize: "18px" }}>&#128197;</span>
            <span style={{ fontFamily: '"Outfit", sans-serif', fontSize: "14px", color: "#1F2124", fontWeight: 500 }}>Sunday, 8AM-9AM, 4PM-5PM</span>
          </div>
        </div>
        <p
          style={{
        ...
        >
          Schedule an appointment today and experience the exceptional care and services that make us a trusted choice for pet owners in the Memorial Park area.
        </p>
        <Link
