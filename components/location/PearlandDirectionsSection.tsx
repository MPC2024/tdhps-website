...
export default function PearlandDirectionsSection() {
  const { t } = useLanguage();
    ...
    <section style={{ backgroundColor: "#ffffff", padding: "80px 20px", textAlign: "center", marginBottom: "65px" }}>
      <div style={{ maxWidth: "700px", margin: "0 auto" }}>
        ...
        <p style={{ fontFamily: '"Outfit", sans-serif', fontSize: "18px", color: "#54595F", marginBottom: "36px" }}>
          {t("loc_pearland_subtitle_nav")}
        </p>
        <a
          href="https://maps.google.com/?q=2810+Business+Center+Dr+%23126,+Pearland,+TX+77584"
          target="_blank"
